...
# 5ページ
  ...
  '井村雪菜': 'ImuraSetsuna'
  '井村雪菜+': 'ImuraSetsuna+'
  '［新春］道明寺歌鈴': 'ShnshunDomyojiKarin'
  '［新春］道明寺歌鈴+': 'ShnshuDomyojiKarin+'

# 6ページ
  '日下部若葉': 'KusakabeWakaba'
  '日下部若葉+': 'Kusakabewakaba+'
  '榊原里美': 'SakagibaraSatomi'
...
# 7ページ
  ...
  '［ひな祭り］福山舞+': 'HinamatsuriFukuyamaMai'
  '［純粋奏者］水本ゆかり': 'JunsuisoushaMizumotoYukari'
  '［純粋奏者］水本ゆかり+': 'JunsuisoushaMizumotoYukari+'
  '古賀小春': 'KogaKoharu'
  '古賀小春+': 'KogaKoharu+'
  ...
  '［沖縄元気っ娘］我那覇響+': 'OkinawagenkikkoGanahaHibiki+'
  '［王子様な女子］菊地真': 'OjisamanajoshKikuchiMakoto'
  '［王子様な女子］菊地真+': 'OjisamanajoshKikuchiMakoto+'
  '［セクシーキャット］前川みく': 'SexycatMaekawaMiku'
  '［セクシーキャット］前川みく+': 'SexycatMaekawaMiku+'

# 8ページ
  '［秘めた輝き］原田美世': 'HimegakagayakiHaradaMiyo'
  ...
  '［薔薇色お姫様］櫻井桃華+': 'BarairoohimesamaSkuraiMomoka+'
...
# 8ページ
  ...
  '［神秘の女神］高垣楓+': 'SimpinomegamiTakagakiKaede+'
...
# 8ページ
  ...
  '［パワフル双子妹］双海亜美+': 'PowerfulfutagoimotoFutamiAmi+'
  '［パワフル双子姉］双海真美': 'PowerfulfutagoimotoFutamiMami'
  '［パワフル双子姉］双海真美+': 'PowerfulfutagoimotoFutamiMami+'
